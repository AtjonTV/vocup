...
namespace Vocup
{
    public partial class MainForm : Form, IMainForm
    {
        public MainForm()
        {
            ...
            if (AppInfo.IsUwp && AppInfo.TryGetVocupInstallation(out var version, out _) &&
        ...
        {
            if (AppInfo.TryGetVocupInstallation(out _, out var uninstallString) &&
        ...
        {
            using (var dialog = new AddWordDialog(CurrentBook) {Owner = this})
            {
                dialog.ShowDialog();
            }
        ...
        public void EditWord()
        {
            ...
            using (var dialog = new EditWordDialog(CurrentBook, selected) {Owner = this})
            {
                dialog.ShowDialog();
            }
